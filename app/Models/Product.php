	 ...
	 public static function get_userproduct_list($sku)
    {
		...
		if(isset($user_rows)){
			...
			if(isset($product_sku_rows)){
				...
				->select(['master_data.id','master_data.product_description','master_data.product_status','master_data.product_name','master_data.product_sku','master_brands.name as brand_name','master_data.price','master_data.was_price','master_data.main_product_images as image','master_data.LS_ID','\DB::raw('count(user_views.user_id)')'])//,'user_views.updated_at as last_visit','user_views.num_views as visit_count'
